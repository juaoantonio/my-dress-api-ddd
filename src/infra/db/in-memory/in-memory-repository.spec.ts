import { InMemoryRepository } from "@infra/db/in-memory/in-memory-repository";
import { AggregateRoot } from "@domain/@shared/aggregate-root";
import { Uuid } from "@domain/@shared/value-objects/uuid.vo";
import { beforeEach, describe, expect, it } from "vitest";
import { EntityNotFoundError } from "@domain/@shared/error/entity-not-found.error";
import { InvalidArgumentError } from "@domain/@shared/error/invalid-argument.error";
